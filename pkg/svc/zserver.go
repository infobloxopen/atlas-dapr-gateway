...
//
// TODO: Extend the AtlasDaprGateway service by defining new RPCs and
...
//
// TODO: Create an implementation of the AtlasDaprGateway server
...
// implementation of AtlasDaprGateway server interface service, but only
...
// Default implementation of the AtlasDaprGateway server interface
type server struct{}
...
func NewBasicServer() (pb.AtlasDaprGatewayServer, error) {
	return &server{}, nil
}
