...
const (
	...
	defaultGatewayURL         = "/atlas-dapr-gateway/v1/"
	...
	defaultDatabaseName     = "atlas_dapr_gateway"
	...
	defaultConfigFile      = ""
	defaultSecretFile      = ""
	defaultApplicationID   = "atlas-dapr-gateway"
	...
	// Dapr
	defaultDaprDestinationList = "invalid_pubsub:invalid_topic"
	defaultDaprSource          = "invalid_pubsub:invalid_topic"
	defaultDaprGrpcPort        = 1250
	defaultDaprAppPort         = 50001
)
...
var (
	...
	flagDaprAppPort         = pflag.Int("dapr.appPort", defaultDaprAppPort, "port of dapr sidecar that listen the subscribe topic")
	flagDaprDestinationList = pflag.String("dapr.destination.list", defaultDaprDestinationList, "list of the dapr publisher pairs, format is pubsub1:topic1,pubsub2:topic2")
	flagDaprSource          = pflag.String("dapr.source", defaultDaprSource, "dapr source pair, format is pubsub:topic")
